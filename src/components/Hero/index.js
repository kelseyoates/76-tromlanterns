...
const Hero = () => (
  ...
  <div className="bg-hero">
        ...
        <button className="border-grey-darker hover:border-grey-dark bg-dark-purple hover:bg-grey font-bold px-6 py-3 rounded text-sm text-white">Let's Go</button>
      </Link>
            </div>
